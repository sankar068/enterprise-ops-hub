    ...
    return (
      <div className="flex min-h-screen flex-col items-center justify-center bg-background p-6 text-center">
        ...
        <p className="mt-2 max-w-md text-sm text-muted-foreground">
          You do not have administrative roles associated with this account. You are being
        ...
        <div className="mb-6 flex flex-col justify-between gap-4 md:flex-row md:items-center">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-0.5">
              Manage cross-department workflows, IT issues, leave records, and expense approvals.
            </p>
          </div>
        ...
        <div className="mb-8 grid grid-cols-2 gap-4 md:grid-cols-5">
          {[
            ...
            },
            {
              ...
              icon: AlertCircle,
              color: `border-destructive/20 bg-destructive/5 text-destructive ${stats.critical > 0 ? "animate-pulse" : ""}`,
            },
          ].map((s) => (
            <div
              key={s.label}
              className={`rounded-2xl border p-4 shadow-soft flex flex-col justify-between bg-card ${s.color.split(" ")[1]} ${s.color.split(" ")[2]}`}
            >
            ...
            {!selectedRequest ? (
              <div className="flex flex-col items-center justify-center text-center text-sm text-muted-foreground flex-1 h-full py-16">
                ...
                <p className="mt-1 max-w-[240px] text-xs">
                  Choose a submission from the table to review details, timeline, and authorize
                  updates.
                </p>
              </div>
            ) : (
              <div className="flex flex-col h-full space-y-5">
                ...
                <div className="border-b border-border/80 pb-4">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <Badge
                      variant="outline"
                      className="border-primary/20 bg-primary/5 uppercase font-bold text-xs"
                    >
                  ...
                  <div className="mt-1 flex flex-wrap gap-2 text-xs text-muted-foreground">
                    <span>
                      Submitted by: <strong>{selectedRequest.employee_name}</strong>
                    </span>
                    <span>•</span>
                ...
                <div className="space-y-4 flex-1 overflow-y-auto max-h-[35vh] pr-1">
                  <div>
                    ...
                    <p className="text-xs leading-relaxed bg-secondary/30 rounded-xl p-3 border border-border/40 whitespace-pre-wrap">
                    ...
                    <div>
                      ...
                      <dl className="grid grid-cols-2 gap-2 text-xs bg-secondary/20 border border-border/40 rounded-xl p-3">
                        {Object.entries(selectedRequest.details).map(([k, v]) => (
                          <div
                            key={k}
                            className="flex flex-col border-b border-border/40 pb-1.5 last:border-b-0 last:pb-0"
                          >
                            <dt className="text-muted-foreground capitalize font-medium">
                    ...
                    {selectedRequest.department === "HR" && (
                      <>
                        ...
                        <Button
                          ...
                          variant="secondary"
                          disabled={
                            submittingAction || selectedRequest.status === "Information Required"
                          }
