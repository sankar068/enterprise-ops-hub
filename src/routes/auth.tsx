...
export const Route = createFileRoute("/auth")({
  head: () => ({
    meta: [
      { title: "Sign in · InnoOps AI" },
      { name: "description", content: "Sign in or create an InnoOps AI account." },
    ],
  }),
  component: AuthPage,
});
      ...
      <div className="relative hidden flex-col justify-between bg-hero p-10 text-white md:flex">
        ...
        <div>
          <h2 className="font-display text-3xl font-bold leading-tight">
            One agent for HR, Finance & IT operations.
          </h2>
          <p className="mt-3 max-w-md text-white/80">
            Describe what you need. Foundry reasons, extracts, and routes it to the right workflow.
          </p>
        </div>
      ...
      <div className="flex items-center justify-center p-6">
        <div className="w-full max-w-md">
          <div className="mb-6 md:hidden">
            <Link to="/" className="flex items-center gap-2">
              <div className="grid h-9 w-9 place-items-center rounded-lg bg-hero text-white">
                <Bot className="h-5 w-5" />
              </div>
              <span className="font-display text-lg font-bold">InnoOps AI</span>
            </Link>
          </div>
            ...
            <TabsContent value="signin" className="mt-6">
              ...
              <div className="mt-6 rounded-lg border border-dashed border-border bg-secondary/50 p-3 text-xs">
                ...
                <p className="mt-2 text-muted-foreground">
                  Sign up first if these accounts don't exist yet — the password is{" "}
                  <code>demo123</code>.
                </p>
              </div>
            </TabsContent>
